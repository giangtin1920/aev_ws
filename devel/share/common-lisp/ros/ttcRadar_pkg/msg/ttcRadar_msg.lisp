...
(cl:in-package ttcRadar_pkg-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <ttcRadar_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ttcRadar_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ttcRadar_pkg-msg:<ttcRadar_msg> is deprecated: use ttcRadar_pkg-msg:ttcRadar_msg instead.")))

(cl:ensure-generic-function 'msg_counter-val :lambda-list '(m))
(cl:defmethod msg_counter-val ((m <ttcRadar_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ttcRadar_pkg-msg:msg_counter-val is deprecated.  Use ttcRadar_pkg-msg:msg_counter instead.")
  (msg_counter m))

(cl:ensure-generic-function 'isObject-val :lambda-list '(m))
(cl:defmethod isObject-val ((m <ttcRadar_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ttcRadar_pkg-msg:isObject-val is deprecated.  Use ttcRadar_pkg-msg:isObject instead.")
  (isObject m))

(cl:ensure-generic-function 'distance-val :lambda-list '(m))
(cl:defmethod distance-val ((m <ttcRadar_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ttcRadar_pkg-msg:distance-val is deprecated.  Use ttcRadar_pkg-msg:distance instead.")
  (distance m))
