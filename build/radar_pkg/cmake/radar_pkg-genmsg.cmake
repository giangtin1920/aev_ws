...
set(MSG_I_FLAGS "-Iradar_pkg:/home/giangtin/aev/aev_ws/src/radar_pkg/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/giangtin/aev/aev_ws/src/radar_pkg/msg/radar_msg.msg" NAME_WE)
add_custom_target(_radar_pkg_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "radar_pkg" "/home/giangtin/aev/aev_ws/src/radar_pkg/msg/radar_msg.msg" ""
)
...
_generate_msg_cpp(radar_pkg
  "/home/giangtin/aev/aev_ws/src/radar_pkg/msg/radar_msg.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/radar_pkg)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/radar_pkg\")")
  # install generated code
  install(
